...
class UserUpdateBpjsForm extends GetView<UserUpdateController> {
  UserUpdateBpjsForm({Key? key}) : super(key: key);
                      ...
                      : Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: kLabelPadding),
                              UpdateImagePicker(controller: controller, jenisDokumen: "ktp"),
                              const SizedBox(height: kDefaultPadding),
                              const H5Text(text: "Upload Foto BPJS", bold: false),
                              const SizedBox(height: kLabelPadding),
                              UpdateImagePicker(controller: controller, jenisDokumen: "bpjs"),
                              const SizedBox(height: kDefaultPadding),
                              CustomButton(
                                size: size,
                                buttonWidth: 0.90,
